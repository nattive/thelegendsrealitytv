...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse float-right" id="navbarsExample03">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.list')}}">List Contestant</a>
            </li>
            {{-- <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $contestant -> name ?? '' }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="email" name="email" id="input-email" value="{{ $contestant -> email ?? '' }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Occupation" value="{{ $contestant -> Occupation ?? '' }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Hobbies" value="{{ $contestant -> Hobbies ?? '' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" value="{{ $contestant -> location ?? '' }}"
                                        class="form-control form-control-alternative"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="photo" value="{{ $contestant -> image ?? '' }}"
